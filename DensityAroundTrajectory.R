...
# kernelBoundary = size of kernel for bounding boxes' caluculation, in no.
# of voxels
...
DensityAroundTrajectory <- function(currentLine,kernelSize,kernelBoundary,xcoord,ycoord,zcoord,method,voxelSize,sigma11,sigma12) {
